...
SASM is an ultra-lightweight x86 assembler written in pure C. At only ~309 lines of code and ~30 KB when compiled with TCC, it supports ~400 x86 instructions including SSE, AVX, x87, MMX, and even AVX-512.
